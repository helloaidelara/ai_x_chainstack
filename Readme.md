...
4. Select your Blockchain protocol, and then click Next. Note that we currently support Raft as the Consensus mechanism.
...
7. Select your region, and then click Create network. 
